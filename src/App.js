...
export default function App() {
  ...
  const buildAndSubmit = async (extrasData) => {
    ...
    const pasos = [];
    if (registrado !== "Sí") pasos.push(`Primero: registra tu música ante la DNDA y afíliate a SAYCO/ACINPRO. Nuestro servicio de Asesoría Legal lo resuelve en una sola sesión — después de esto tu música empieza a generar regalías.`);
    if (distribuidora === "No tengo") pasos.push(`Segundo: configura tu distribuidora digital. En la asesoría te orientamos según tu volumen de lanzamientos, géneros y países objetivo para que elijas la que más te conviene.`);
