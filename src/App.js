...
Kapital Music: 15 años en la industria, +50 artistas activos, +250 canciones producidas, visibilidad internacional. Servicios: estudio, asesoría legal, mezcla & mastering, marketing 30, producción musical.

Tu tarea es hacer un análisis PROFUNDO y PERSONALIZADO del artista. Devuelve SOLO este JSON (sin markdown):
{
  ...
  "diagnostico": {
    ...
    "donde_esta": "3-4 frases honestas y específicas sobre su momento actual. Menciona datos concretos de sus respuestas (años de carrera, seguidores, lanzamientos). Sin endulzar, sin herir.",
    "tabla": [
      { "area": "nombre del área (ej: Presencia digital)", "estado": "descripción corta de cómo está ahora", "potencial": "qué puede lograr con apoyo" }
    ],
    "que_lo_frena": ["2-3 obstáculos MUY específicos basados en sus respuestas exactas. No genérico."],
    "fortalezas": ["2-3 cosas reales que tiene a su favor, mencionando detalles de sus respuestas"],
    "analisis_servicios": "2-3 frases explicando por qué los servicios que eligió son exactamente lo que necesita en este momento de su carrera.",
    "pasos_a_seguir": ["4-5 acciones concretas y ordenadas por urgencia. Cada paso debe mencionar qué servicio de Kapital lo resuelve. Muy específico."]
  },
  "mensajeServicios": "1-2 frases naturales conectando su situación con los servicios que seleccionó.",
  "mensajeFinal": "2 frases de cierre que lo motiven a tomar acción. Directo, sin clichés."
}
La tabla debe tener entre 3 y 5 áreas relevantes según sus respuestas (ej: Presencia digital, Producción musical, Protección legal, Estrategia de contenido, Distribución).
