...
const SERVICES = [
  {
    ...
    subsections: [
      { label: "Estudio A", imgs: [CL+"estudio-a-1_yitif2",CL+"estudio-a-2_ax1jy5",CL+"estudio-a-3_wnlvfd",CL+"estudio-a-4_ypaaea"] },
      { label: "Estudio B", imgs: [CL+"estudio-b-1_hlduee",CL+"estudio-b-2_wpzby5",CL+"estudio-b-3_gqeg4h",CL+"estudio-b-4_asp8p4"] }
    ]
  },
  { icon: "⚖️", title: "Asesoría Legal", tag: "PROTECCIÓN", desc: "Contratos, registro SAYCO/ACINPRO, distribuidoras y todo lo que necesitas para que tu carrera sea un negocio real.", imgs: [] },
  ...
  { icon: "📲", title: "Marketing 30", tag: "CRECIMIENTO", desc: "Análisis de contenido, crecimiento orgánico, pauta en Meta, parrilla mensual y asesoramiento de marca. Un mes completo de activación.", imgs: [] },
  {
    ...
    subsections: [
      { label: "Money Makers", imgs: [CL+"money-makers-1_ezbtfk",CL+"money-makers-2_e8zimp",CL+"money-makers-3_oba1ls"] },
      { label: "TunyD", imgs: [CL+"tunyd-1_sr6wde",CL+"tunyd-2_wo2quf",CL+"tunyd-3_ai2n3c"] }
    ]
  },
];
    ...
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "'Raleway',sans-serif", width: "100%", overflowX: "hidden" }}>
      ...
      <nav className="nav">
        <div className="nav-logo">
          <div className="nav-k">
            <img src={LOGO_URL} alt="Kapital Music" className="nav-logo-img" onError={e=>{e.target.style.display='none';e.target.parentNode.textContent='K';}} />
          </div>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {SERVICES.map((s, i) => (
                <div key={i} style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 12, padding: "16px" }}>
                  <div style={{ display: "flex", gap: 14, alignItems: "flex-start", marginBottom: (s.subsections || (s.imgs && s.imgs.length > 0)) ? 12 : 0 }}>
