...
function Ecosystem() {
  ...
  const bentoCards = [
    { icon: "🎙️", title: "Estudio Profesional", desc: "Dos estudios de última generación. El ambiente que tu música merece.", color: "#C0392B" },
    { icon: "⚖️", title: "Blindaje Legal", desc: "Tu música protegida desde el primer acorde hasta el último stream.", color: "#8a0c0c" },
        ...
        <div style={{ position: "absolute", inset: 0 }}>
          <svg viewBox="0 0 100 100" style={{ width: "100%", height: "100%", overflow: "visible" }}>
            ...
            {satellites.map((s, i) => {
              ...
              const isHov = hovered === i;
              return (
                <g key={i} style={{ cursor: "pointer", animation: `orbit${i} ${12+i}s linear infinite` }}
            ...
            {/* Center node */}
            <circle cx="50" cy="50" r="12" fill="#0d0000" stroke="#C0392B" strokeWidth="0.6" filter="url(#fg)"/>
            <text x="50" y="48" textAnchor="middle" fontSize="4.5" fill="#fff" fontFamily="Raleway,sans-serif" fontWeight="900" letterSpacing="0.5">KAPITAL</text>
            <text x="50" y="53.5" textAnchor="middle" fontSize="3" fill="rgba(192,57,43,.9)" fontFamily="Raleway,sans-serif" fontWeight="700" letterSpacing="1">MUSIC</text>
          </svg>
        </div>
      </div>
